...
public class Quarry extends Building {
    ...
    public Quarry(MapGUI mapGUI) {
        super(mapGUI);
        setImage(ResourceManager.getImage("Quarry"));
        this.type = "Quarry";
        this.size = new Pair(4, 4);
        this.health = Settings.QUARRY_INITIAL_HEALTH;
    }
    ...
    public AnchorPane objectsMenuAnchorPane(boolean owner) {
        ...
        transition(destroy);
        destroy.setOnAction(event -> Quarry.this.mapGUI.removeBuildings(Quarry.this));
    ...
    public void initializeAnchorPane() {
        ...
        ImageView imageView = new ImageView(ResourceManager.getImage("Quarry"));
        ...
        ProgressBar healthBar = new ProgressBar((double) this.health / Settings.QUARRY_INITIAL_HEALTH);
